...
<div class="report-container">
    <div class="report-header">
        ...
        <div class="actions">
            <form action="{{ route('activities.daily-report') }}" method="GET" class="date-form">
                <input type="date" name="date" value="{{ request('date', now()->format('Y-m-d')) }}" class="form-control" onchange="this.form.submit()">
            </form>
    ...
    <div class="activities-section">
        <h2>Activities for {{ request('date', now()->format('Y-m-d')) }}</h2>
